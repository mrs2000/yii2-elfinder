...
class Controller extends BaseController
{
    ...
    public function actionManager()
    {
        ...
        if (isset($_GET['callback'])) {
            ...
            $options['getFileCallback'] = new JsExpression('function(file){if (window!=window.top) {var parent = window.parent;}else{var parent = window.opener;} if(parent.ElFinderFileCallback.callFunction(' . Json::encode($_GET['callback']) . ', file)) window.close(); }');
        }
